export const SecondCriteria = [
	...
	},
	{
		...
		answers: [
			{
				key: 'A',
				answer: 'Có, sản phẩm có thể chứa một số hóa chất độc hại dưới ngưỡng cho phép trong Tiêu chuẩn/Quy chuẩn quốc gia nhưng doanh nghiệp chưa có biện pháp phòng ngừa việc hoá chất đó có thể rò rỉ ra môi trường.',
				point: 0
			},
			{
				key: 'B',
