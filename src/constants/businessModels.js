export const businessModels = [
  {
    label: 'Doanh nghiệp sản xuất, chế biến, chế tạo (sản phẩm hàng hoá hữu hình)',
    value: 'Doanh nghiệp sản xuất, chế biến, chế tạo (sản phẩm hàng hoá hữu hình)'
  },
  {
    label: 'Doanh nghiệp phi sản xuất (thương mại, dịch vụ…) hoặc sản xuất sản phẩm vô hình (như phần mềm, ứng dụng CNTT…)',
