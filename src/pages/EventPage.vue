...
<template>
    <Banner img-src="https://lh3.googleusercontent.com/pw/AIL4fc_hYi5ZP_Q3Uq-sw5CBb0c123bFv0FIn-bK8GLtWKiMtbmBWA3BxFS6HSgGNATY4wk6se2X_UfuwlpclwceK46GQFc431_bh2DRT1yNPVOIcP6kt1PECKl8L2cIXNYjr51qjncyRLpJF32ohX4oG0yY=w1280-h800-s-no?authuser=0"
            ...
            <a-spin :spinning="loadingNews">
                <div class="grid xl:grid-cols-4 md:grid-cols-3 gap-5">
                    <a-card v-for="news in newsToShow" data-aos="fade-right"
                        ...
                        <div class="space-y-2">
                            <a :href="news.content" class="font-bold line-clamp-2 text-ellipsis text-base"
                               target="_blank">
                                {{ news.title }}
                            </a>
                            <div>
            ...
            <a-spin :spinning="loadingEvent">
                <div class="grid xl:grid-cols-4 md:grid-cols-3 gap-5">
                    <a-card v-for="event in eventsToShow" data-aos="fade-left"
                        ...
                        <div class="space-y-2">
                            <a :href="event.content" class="font-bold line-clamp-2 text-ellipsis text-base"
                               target="_blank">
                                {{ event.title }}
                            </a>
                            <div>
